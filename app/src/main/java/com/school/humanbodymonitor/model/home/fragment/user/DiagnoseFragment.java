...
public class DiagnoseFragment extends Fragment {
    ...
    private RecyclerView listDiagnose;
    private DiagnoseDoctorAdapter adapter;
    ...
    private void initView(View view) {
        listDiagnose = view.findViewById(R.id.list_diagnose);

        adapter = new DiagnoseDoctorAdapter();
        listDiagnose.setLayoutManager(new LinearLayoutManager(getContext(),LinearLayoutManager.VERTICAL,false));
        listDiagnose.setAdapter(adapter);
    }
}